...
export const FavButton = ({ data }: { data: ICharacter }) => {
  ...
  return React.useMemo(() => {
    ...
    return (
      <button
        className={`w-4/5 mx-auto rounded-xl  shadow-none bg-gradient-to-br from-gray-50 to-gray-300/70 text-gray-400 text-lg p-2 px-3 m-1 hover:text-emerald-500 active:scale-90 duration-75
